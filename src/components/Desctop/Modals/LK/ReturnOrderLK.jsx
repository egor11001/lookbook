...
const ReturnOrderLK = ({ visible, setVisible, id }) => {
  const [activeStatus, setActiveStatus] = useState('canceled');
  return (
    <Modal open={visible}>
      <Box sx={style}>
        ...
        <div className={styles.left}>
          <h1 className={styles.title}>Возврат №{order.id}</h1>
